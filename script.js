...
let uploadedFile = null; // Глобальная переменная для хранения загруженного файла
...
function handleFileSelection(event) {
    ...
    if (!file || file.name !== 'ceh.txt') {
        ...
        document.getElementById('loadButton').style.display = 'none'; // Скрываем кнопку
        return;
    }
    ...
    // Показываем кнопку "Загрузить на торговую точку"
